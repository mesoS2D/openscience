...
# python syntax works, e.g., you can do np.arange(10). 
# Note - for a 24 hour period and 15 minute output, there 96
# Note - for a 24 hour period and 3 min 45 s output there are 384 entries
