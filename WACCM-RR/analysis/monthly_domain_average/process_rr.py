...
def main():
    ...
    cluster = PBSCluster(
        ...
        name=f'{timestr}',
        cores=72,                         # Total cores for the entire job
        memory='300GB',                   # Memory per job (worker)
        processes=6,                    # Number of Dask worker processes - threads per worker calculated as cores/perocesses
        resource_spec='select=2:ncpus=36:mem=150GB',  # Adjust the resource specification as needed
    ...
    file_map = 'map_8.8e-3hPa_T_O_U_V_OMEGA_CO2_CO_NO_O3_H2O_lat_lon_FWmaHIST_ne0CONUSne30x8_ne0CONUSne30x8_mt12_no_conus_gravity_waves.cam.h0.2010-12-31-00000.nc'
